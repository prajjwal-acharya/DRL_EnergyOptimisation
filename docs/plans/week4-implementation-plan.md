...
### C2. `scripts/forecasting/15_train_forecasters.py --config configs/week4-forecasting.yaml`
...
### C3. `scripts/forecasting/16_compare_forecasters.py`
...
### D1. `scripts/forecasting/17_gate_week4.py` (mirror `14_gate_week3.py` structure; hard pass/fail)
...
**Acceptance gate D:** `./.venv/bin/python scripts/forecasting/17_gate_week4.py` exits 0; repo green;
...
6. `./.venv/bin/python -m pytest -q` passes; `./.venv/bin/python scripts/forecasting/17_gate_week4.py`
   exits 0.
